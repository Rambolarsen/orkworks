...
- Taskmaster Fix with AI carries a stable recommendation ID into the active session; the agent can inspect the recommendation through the local sidecar and report verified completion through its session-scoped capability (see [ADR 0049](docs/adr/0049-taskmaster-recommendation-aware-agent-handoff.md))
