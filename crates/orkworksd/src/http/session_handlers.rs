...
pub(crate) async fn request_session_plan_review(
    ...
    let prompt = format!("Please spawn a separate review subagent — not the agent that wrote it — to review the plan or specification at {relative}. Have it check for missing requirements, risky assumptions, and unclear steps, then report its findings.\r");
...
mod tests {
    ...
    async fn plan_review_submits_the_fixed_prompt_before_recording_the_event() {
        ...
        assert_eq!(data, "Please spawn a separate review subagent — not the agent that wrote it — to review the plan or specification at specs/plan.md. Have it check for missing requirements, risky assumptions, and unclear steps, then report its findings.\r");
